    ...
    on_install(function (package)
        io.writefile("xmake.lua", [[
            target("compiler-rt-builtins")
                ...
                -- local compiler_rt_target_files = {
                --     unpack(generic_sources),
                --     unpack(atomic_files)
                -- }
                ...
                if is_arch("x86_64") then
                    -- table.insert(compiler_rt_target_files, {
                    --     unpack(x86_files),
                    --     unpack(x86_64_files),
                    --     unpack(generic_nonarm_sources)
                    -- })
                ...
                elseif is_arch("aarch64") then
                    -- table.insert(compiler_rt_target_files, {
                    --     unpack(aarch64_files),
                    --     unpack(generic_tf_sources),
                    --     unpack(generic_nonx86_64_sources),
                    --     unpack(generic_nonarm_sources)
                    -- })
                ...
                -- add_files(unpack(compiler_rt_target_files))
        ]])
        local configs = { }
