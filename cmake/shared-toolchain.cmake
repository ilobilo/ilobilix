...
set(_ILOBILIX_DEFINES
    ...
    "cpu_local=[[gnu::section(\".percpu\")]] ::cpu::per::storage"
    "cpu_local_init(name, ...)=void (*name ## _init_func__)(std::uintptr_t) = [](std::uintptr_t base) { name.initialise_base(base __VA_OPT__(,) __VA_ARGS__)^ }^ [[gnu::section(\".percpu_init\"), gnu::used]] const auto name ## _init_ptr__ = name ## _init_func__"
)
...
if(_ILOBILIX_ENABLE_LTO)
    list(APPEND _SHARED_LINKER_FLAGS
        "-flto=full"
        "-funified-lto"
        "-Wl,--lto=full"
    )
...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
    list(APPEND _EXE_LINKER_FLAGS "-Wl,--strip-debug")
    list(APPEND _SHARED_LINKER_FLAGS "-Wl,--strip-debug")
endif()
